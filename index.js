...
const url = 'https://6334c678ea0de5318a08cea5.mockapi.io/productos'
...
addEventListener('DOMContentLoaded',requestGET(url))
...
formulario.addEventListener('submit',(e)=>{
    ...
    if (flag == false) {
        ...
        requestPost(url,arrayDatos)
        formulario.reset()
    
    } else {
        let editID = localStorage.getItem('editID')

        requestPut(`${url}/${editID}`, arrayDatos)
